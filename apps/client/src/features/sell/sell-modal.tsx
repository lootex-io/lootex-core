...
import { NATIVE } from '@lootex-core/sdk/token';
...
export const SellModal = ({
  ...
  const { address, connector, chainId: connectionChainId } = useConnection();
        ...
        {step === 'success' && (
          <>
            ...
            <div className="flex flex-col items-stretch gap-4">
              ...
              <OrderDetails
                items={createOrdersMutation.data?.lootexOrders.map((order) => ({

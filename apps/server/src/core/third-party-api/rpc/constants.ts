...
export const IPFS_GATEWAYS = [
  'https://ipfs.io/ipfs/',
  'https://lootex.myfilebase.com/ipfs/',
  'https://lootex.mypinata.cloud/ipfs/',
  'https://gateway.pinata.cloud/ipfs/',
];
export const ARWEAVE_GATEWAY = 'https://arweave.net/';

export const getChain = (chain: Chain) => {
  return ChainMap[chain].RPC;
};

export const HTTP_FETCH_BATCH = 10;
...
export enum SupportedMethod {
  ...
  BALANCEOF2 = 'balanceOf(address,uint256)',
...
export const MANTLE_CONTRACT_ADDRESS =
  '0xcA11bde05977b3631167028862bE2a173976CA11';
export const MANTLE_CONTRACT_ADDRESS_TESTNET =
  '0xcA11bde05977b3631167028862bE2a173976CA11';

export const STUDIO_CONTRACT_ABI = [
  {
    inputs: [],
    stateMutability: 'nonpayable',
    type: 'constructor',
